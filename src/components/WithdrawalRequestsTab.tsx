      ...
      <div className="mb-6">
        <div className="flex space-x-4 border-b border-gray-200 dark:border-gray-700">
          <button 
            ...
            className={`py-2 px-4 border-b-2 ${activeRequestTab === 'unconfirmed' ? 'border-orange-primary text-orange-primary' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'} font-medium`}
          >
            Unconfirmed
          </button>
          <button 
            onClick={() => setActiveRequestTab('confirmed')}
            className={`py-2 px-4 border-b-2 ${activeRequestTab === 'confirmed' ? 'border-orange-primary text-orange-primary' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'} font-medium`}
          >
            Confirmed
          </button>
        </div>
        ...
        <div className="space-y-4">
          {unconfirmedRequests.length > 0 ? (
            unconfirmedRequests.map((request) => (
              <div key={request.id} className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 hover:shadow-md transition-shadow">
                ...
                <div className="flex items-center">
                  ...
                  <button className="ml-4 text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 text-sm font-medium">
                    Cancel
                  </button>
                </div>
              </div>
